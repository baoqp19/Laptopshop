...
import vn.laptopshop.laptopshop.domain.Product_;
...
public class ProductService {
    ...
    public Page<Product> fetchProducts(Pageable page, String name) {
        return this.productRepository.findAll(ProductSpect.nameLike(name), page);
    }
    ...
    public Page<Product> fetchProductsWithSpec(Pageable page, double min) {
        return this.productRepository.findAll(ProductSpect.minPrice(min), page);
    }

    // case 2
    // public Page<Product> fetchProductsWithSpec(Pageable page, double max) {
    // return this.productRepository.findAll(ProductSpect.maxPrice(max), page);
    // }

    // case 3
    // public Page<Product> fetchProductsWithSpec(Pageable page, String factory) {
    // return this.productRepository.findAll(ProductSpect.matchFactory(factory),
    // page);
    // }
    ...
    // factory) {
    // return this.productRepository.findAll(ProductSpect.matchListFactory(factory),
    // page);
    // }
    ...
    // double min = 10000000;
    // double max = 15000000;
    // return this.productRepository.findAll(ProductSpect.matchPrice(min, max),
    // page);
